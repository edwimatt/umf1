...
const secureServer = https.createServer({
    key: fs.readFileSync('/etc/pki/tls/private/understandingmyfacility.com.key', { encoding: 'utf8', flag: 'r' }),
    cert: fs.readFileSync("/etc/pki/tls/certs/understandingmyfacility.com.crt", { encoding: 'utf8', flag: 'r' })
}, app);
